...
from models_vqa_mutan import VqaLstmModel, VqaLstmCnnAttentionModel
from data import EqaDataset, EqaDataLoader
from metrics import VqaMetric

from models_vqa_mutan import get_state, repackage_hidden, ensure_shared_grads
from data import load_vocab

import pdb


def eval(rank, args, shared_model, best_eval_acc=0,  checkpoint=None, epoch = 0, mode = "train"):
...
if __name__ == '__main__':
    ...
    print(args.__dict__)
    print("Working with pruned datasets")
    ...
    if args.mode == 'eval':
        ...
        eval(0, args, shared_model, checkpoint = checkpoint, mode = "eval")
